    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, default='', verbose_name='Описание')),
                ('publisher', models.CharField(blank=True, default='', max_length=32, verbose_name='Издатель')),
                ...
                ('discount', models.FloatField(blank=True, default=1.0, verbose_name='Множитель скидки')),
                ...
                ('cover_list', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict, verbose_name='Список обложек')),
